...
<div class="container-fluid px-0">
    <div class="dashboard-header fly-in">
        ...
        <p class="text-muted small mb-0">Find discussions in your joined groups by title or description.</p>
    </div>
    ...
    @else
        <div class="card dashboard-card text-center py-4 fly-in">
            ...
            @elseif(auth()->user()->groups()->count() === 0 && ! auth()->user()->isAdmin())
                <p class="text-muted small mb-2">Join a group first to search its topics.</p>
